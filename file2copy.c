...
int main(void)
{
    ...
    while (fgets(text_read, MAX_TEXT_LINE_LENGTH, my_file))
    {
        ...
        if (p != 0)
        {
            ...
            /*
            strcpy(Elmt(M, linecounter, 0),namaWahana);
            Elmt(M, linecounter, 1) = *temp_text1;
            Elmt(M, linecounter, 2) = *temp_text2;
            Elmt(M, linecounter, 3) = *temp_text3;
            Elmt(M, linecounter, 4) = *temp_text4;
            Elmt(M, linecounter, 5) = *temp_text5;
            Elmt(M, linecounter, 6) = *temp_text6;*/

            //char anjing[10];
            //anjing[0] = '\0';
            //strcpy(anjing, namaWahana[0]);
